...
public class Game {
    ...
    private void playGame() throws InterruptedException {
        ...
        GameCharacter hero = new GameCharacter("Кретен", 10, 20, 2);
    ...
    private void fight(GameCharacter hero, GameCharacter enemy) {
        ...
        while (true) {
            ...
            System.out.println("2. Поједи сендвич (" + hero.getHealingPotions() + " преостало)");
            ...
            if (choice == 1) {
                ...
                if (hero.getHealingPotions() == 0) {
                    System.out.println("Немате више сендвича!");
                } else {
            ...
            if (enemy.getHp() == 0) {
                System.out.println(enemy.getName() + " је поражен");
                break;
            }
    ...
    private boolean askToPlayAgain() {
        ...
        playMusic(Music.GAME_OVER_MUSIC, false);
